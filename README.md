...
Under folder __output/quantification_results/demo.stat/__, there are four files specifically generated by pRSEM:
...
- __demo_prsem.all_tr_prior__: prior parameters for all the isoforms. 
